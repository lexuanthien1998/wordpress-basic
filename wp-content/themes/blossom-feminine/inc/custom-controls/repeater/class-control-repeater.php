...
if( ! class_exists( 'Blossom_Feminine_Control_Repeater' ) ) {
    ...
    class Blossom_Feminine_Control_Repeater extends WP_Customize_Control {
    	 ...
    	 * @var string
    	 */
    	public $type = 'blossom_feminine_repeater';
    		...
    		<script type="text/html" class="customize-control-repeater-content">
    			...
    			<li class="repeater-row minimized" data-row="{{{ index }}}">
    				...
    				<div class="repeater-row-content">
    					<# _.each( data, function( field, i ) { #>
    						...
    						<div class="repeater-field repeater-field-{{{ field.type }}}">
    							...
    							<# } else if ( field.type === 'image' || field.type === 'cropped_image' ) { #>
    								...
    								<figure class="kirki-image-attachment" data-placeholder="<?php echo esc_attr__( 'No Image Selected', 'blossom-feminine' ); ?>" >
    									<# if ( field.default ) { #>
    										<# var defaultImageURL = ( field.default.url ) ? field.default.url : field.default; #>
    										<img src="{{{ defaultImageURL }}}">
    									<# } else { #>
    										<?php echo esc_html__( 'No Image Selected', 'blossom-feminine' ); ?>
    									<# } #>
    								</figure>
    
    								<div class="actions">
    									<button type="button" class="button remove-button<# if ( ! field.default ) { #> hidden<# } #>"><?php echo esc_html__( 'Remove', 'blossom-feminine' ); ?></button>
    									<button type="button" class="button upload-button" data-label=" <?php echo esc_attr__( 'Add Image', 'blossom-feminine' ); ?>" data-alt-label="<?php echo esc_attr__( 'Change Image', 'blossom-feminine' ); ?>" >
    										<# if ( field.default ) { #>
    											<?php echo esc_html__( 'Change Image', 'blossom-feminine' ); ?>
    										<# } else { #>
    											<?php echo esc_html__( 'Add Image', 'blossom-feminine' ); ?>
    										<# } #>
    									</button>
    									<# if ( field.default.id ) { #>
    							...
    							<# } else if ( field.type === 'upload' ) { #>
    								...
    								<figure class="kirki-file-attachment" data-placeholder="<?php echo esc_attr__( 'No File Selected', 'blossom-feminine' ); ?>" >
    									<# if ( field.default ) { #>
    									...
    									<# } else { #>
    										<?php echo esc_html__( 'No File Selected', 'blossom-feminine' ); ?>
    									<# } #>
    								</figure>
    
    								<div class="actions">
    									<button type="button" class="button remove-button<# if ( ! field.default ) { #> hidden<# } #>"></button>
    									<button type="button" class="button upload-button" data-label="<?php echo esc_attr__( 'Add File', 'blossom-feminine' ); ?>" data-alt-label="<?php echo esc_attr__( 'Change File', 'blossom-feminine' ); ?>" >
    										<# if ( field.default ) { #>
    											<?php echo esc_html__( 'Change File', 'blossom-feminine' ); ?>
    										<# } else { #>
    											<?php echo esc_html__( 'Add File', 'blossom-feminine' ); ?>
    										<# } #>
    									</button>
    									<# if ( field.default.id ) { #>
    										<input type="hidden" class="hidden-field" value="{{{ field.default.id }}}" data-field="{{{ field.id }}}" >
    					...
    					<# }); #>
    					<button type="button" class="button-link repeater-row-remove"><?php echo esc_html__( 'Remove', 'blossom-feminine' ); ?></button>
    				</div>
    			</li>
    		</script>
    		<?php
